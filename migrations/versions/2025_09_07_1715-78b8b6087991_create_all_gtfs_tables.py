...
Revision ID: 78b8b6087991
Revises: b0f49b445875
Create Date: 2025-09-07 17:15:11.348184
...
def upgrade() -> None:
    ...
    op.execute('CREATE INDEX IF NOT EXISTS idx_shapes_geom ON shapes USING gist (geom)')
    ...
    op.execute('CREATE INDEX IF NOT EXISTS idx_depots_location ON depots USING gist (location)')
