...
// Local static theme values (arknet-like) to avoid ThemeProvider dependency
const theme = {
  ...
  const t = {
    bg: { elevated: '#07102a', primary: '#000b2a', card: '#07102a' },
    border: { default: 'rgba(255,255,255,0.04)', subtle: 'rgba(255,255,255,0.03)', hover: 'rgba(255,255,255,0.06)' },
    text: { primary: '#ffffff', secondary: '#cbd5e1', tertiary: '#94a3b8' },
    interactive: { primary: { default: '#FFC726' }, accent: { default: '#FFD54F' } },
