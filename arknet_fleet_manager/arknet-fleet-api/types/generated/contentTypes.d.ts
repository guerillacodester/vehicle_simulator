...
export interface ApiBlockBlock extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service blocks for vehicle scheduling';
    displayName: 'Block';
    pluralName: 'blocks';
    singularName: 'block';
  };
  ...
  attributes: {
    block_id: Schema.Attribute.UID<'block_name'> & Schema.Attribute.Required;
    block_name: Schema.Attribute.String;
    break_duration_minutes: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    total_distance_km: Schema.Attribute.Decimal;
    total_duration_minutes: Schema.Attribute.Integer;
    total_revenue_km: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCountryCountry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Countries in the fleet management system';
    displayName: 'Country';
  ...
  attributes: {
    ...
    country_id: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    depots: Schema.Attribute.Relation<'oneToMany', 'api::depot.depot'>;
...
export interface ApiDepotDepot extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Vehicle depots for fleet management';
    displayName: 'Depot';
    pluralName: 'depots';
    singularName: 'depot';
  };
  ...
  attributes: {
    ...
    capacity: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<50>;
    country: Schema.Attribute.Relation<'manyToOne', 'api::country.country'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    depot_id: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    drivers: Schema.Attribute.Relation<'oneToMany', 'api::driver.driver'>;
    is_active: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
...
export interface ApiDriverDriver extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Drivers in the fleet management system';
    displayName: 'Driver';
    pluralName: 'drivers';
    singularName: 'driver';
  };
  ...
  attributes: {
    assigned_vehicles: Schema.Attribute.Relation<
      'oneToMany',
      'api::vehicle.vehicle'
    >;
    country: Schema.Attribute.Relation<'manyToOne', 'api::country.country'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    driver_id: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    email: Schema.Attribute.Email;
    ...
    home_depot: Schema.Attribute.Relation<'manyToOne', 'api::depot.depot'>;
...
export interface ApiGpsDeviceGpsDevice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'GPS tracking devices for vehicles';
  ...
  attributes: {
    assigned_vehicle: Schema.Attribute.Relation<
      'oneToOne',
      'api::vehicle.vehicle'
    >;
    battery_level: Schema.Attribute.Integer &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    device_id: Schema.Attribute.UID<'device_serial'> &
      Schema.Attribute.Required;
    device_serial: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ...
    publishedAt: Schema.Attribute.DateTime;
    signal_strength: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Transit routes in the fleet management system';
    displayName: 'Route';
    pluralName: 'routes';
    singularName: 'route';
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Service schedules and calendars';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    saturday: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    service_id: Schema.Attribute.UID<'service_name'> &
      Schema.Attribute.Required;
...
export interface ApiShapeShape extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Route geometry shapes';
    displayName: 'Shape';
    pluralName: 'shapes';
    singularName: 'shape';
  };
...
export interface ApiStopStop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location_type: Schema.Attribute.Enumeration<
      ['stop', 'station', 'entrance', 'generic_node', 'boarding_area']
    > &
      Schema.Attribute.DefaultTo<'stop'>;
    longitude: Schema.Attribute.Decimal;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    parent_station: Schema.Attribute.String;
    platform_code: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    stop_id: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    stop_url: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wheelchair_boarding: Schema.Attribute.Enumeration<
      ['unknown', 'accessible', 'not_accessible']
    > &
      Schema.Attribute.DefaultTo<'unknown'>;
    zone_id: Schema.Attribute.String;
  };
}
...
export interface ApiTripTrip extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual trips on routes';
    displayName: 'Trip';
    pluralName: 'trips';
    singularName: 'trip';
  };
  ...
  attributes: {
    bikes_allowed: Schema.Attribute.Enumeration<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direction_id: Schema.Attribute.Enumeration<['outbound', 'inbound']>;
    is_active: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    trip_id: Schema.Attribute.UID<'trip_headsign'> & Schema.Attribute.Required;
    trip_short_name: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wheelchair_accessible: Schema.Attribute.Enumeration<
      ['unknown', 'accessible', 'not_accessible']
    > &
      Schema.Attribute.DefaultTo<'unknown'>;
  };
...
export interface ApiVehicleVehicle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Vehicles in the fleet management system';
    displayName: 'Vehicle';
    pluralName: 'vehicles';
  ...
  attributes: {
    ...
    assigned_driver: Schema.Attribute.Relation<
      'manyToOne',
      'api::driver.driver'
    >;
    braking_mps2: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<1.8>;
    capacity: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<11>;
    country: Schema.Attribute.Relation<'manyToOne', 'api::country.country'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    eco_mode: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    gps_device: Schema.Attribute.Relation<
      'oneToOne',
      'api::gps-device.gps-device'
    >;
    home_depot: Schema.Attribute.Relation<'manyToOne', 'api::depot.depot'>;
    ...
    > &
      Schema.Attribute.Private;
    max_speed_kmh: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    >;
    preferred_route: Schema.Attribute.Relation<'manyToOne', 'api::route.route'>;
