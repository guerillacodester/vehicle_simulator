 ...
 */
const mapRegionType = (adminLevel) => {
 ...
 */
const processPOIsGeoJSON = async (country) => {
    var _a, _b, _c, _d, _e;
    ...
    for (let i = 0; i < geojson.features.length; i += CHUNK_SIZE) {
        ...
        for (const feature of chunk) {
            let lat, lon;
            let geometryType = (_a = feature.geometry) === null || _a === void 0 ? void 0 : _a.type;
            // Handle different geometry types
            if (((_b = feature.geometry) === null || _b === void 0 ? void 0 : _b.type) === 'Point') {
                [lon, lat] = feature.geometry.coordinates;
            }
            else if (((_c = feature.geometry) === null || _c === void 0 ? void 0 : _c.type) === 'Polygon') {
                // Calculate centroid of polygon
                const coordinates = feature.geometry.coordinates[0]; // Outer ring
                lon = coordinates.reduce((sum, p) => sum + p[0], 0) / coordinates.length;
                lat = coordinates.reduce((sum, p) => sum + p[1], 0) / coordinates.length;
            }
            else if (((_d = feature.geometry) === null || _d === void 0 ? void 0 : _d.type) === 'MultiPolygon') {
                ...
                console.warn(`[Country] Skipping POI with unsupported geometry type: ${(_e = feature.geometry) === null || _e === void 0 ? void 0 : _e.type}`);
                continue;
            }
            ...
            const createdPOI = await strapi.entityService.create('api::poi.poi', {
                data: {
                    name,
 ...
 */
const processLanduseGeoJSON = async (country) => {
    var _a;
    ...
    for (let i = 0; i < geojson.features.length; i += CHUNK_SIZE) {
        ...
        for (const feature of chunk) {
            if (!feature.geometry || (feature.geometry.type !== 'Polygon' && feature.geometry.type !== 'MultiPolygon')) {
                console.warn(`[Country] Skipping Landuse with unsupported geometry type: ${(_a = feature.geometry) === null || _a === void 0 ? void 0 : _a.type}`);
                continue;
            }
            const props = feature.properties || {};
            ...
            const createdZone = await strapi.entityService.create('api::landuse-zone.landuse-zone', {
                data: {
                    name,
 ...
 */
const processRegionsGeoJSON = async (country) => {
    var _a;
    ...
    for (const feature of geojson.features) {
        if (!feature.geometry || (feature.geometry.type !== 'Polygon' && feature.geometry.type !== 'MultiPolygon')) {
            console.warn(`[Country] Skipping Region with unsupported geometry type: ${(_a = feature.geometry) === null || _a === void 0 ? void 0 : _a.type}`);
            continue;
        }
        const props = feature.properties || {};
        ...
        const createdRegion = await strapi.entityService.create('api::region.region', {
            data: {
                name,
 ...
 */
const processHighwaysGeoJSON = async (country) => {
    var _a;
    ...
    for (let i = 0; i < geojson.features.length; i += BATCH_SIZE) {
        ...
        const highwaysToInsert = [];
        const coordsByIndex = [];
        // Prepare highway records
        for (let batchIndex = 0; batchIndex < batch.length; batchIndex++) {
            const feature = batch[batchIndex];
            if (((_a = feature.geometry) === null || _a === void 0 ? void 0 : _a.type) !== 'LineString')
                continue;
        ...
        if (shapesToInsert.length > 0) {
            ...
            for (const { documentId } of coordsByIndex) {
                ...
                if (!numericId)
                    continue;
                const highwayShapes = insertedShapes.filter(s => s.document_id.startsWith(`hs_${numericId}_`));
...
exports.default = {
    ...
    async beforeDelete(event) {
        ...
        try {
            ...
            const highways = await strapi.entityService.findMany('api::highway.highway', {
                filters: { country: countryId }
            });
            ...
            for (const highway of highways) {
                ...
                await strapi.entityService.delete('api::highway.highway', highway.id);
            }
    ...
    async beforeUpdate(event) {
        ...
        try {
            ...
            const currentCountry = await strapi.documents('api::country.country').findOne({
                ...
                populate: ['pois_geojson_file', 'landuse_geojson_file', 'regions_geojson_file', 'highways_geojson_file']
            });
            console.log('[Country] Current POI file:', ((_a = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.pois_geojson_file) === null || _a === void 0 ? void 0 : _a.id) || 'NONE', '(full object exists:', !!(currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.pois_geojson_file), ')');
            console.log('[Country] Current Places file:', ((_b = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.place_names_geojson_file) === null || _b === void 0 ? void 0 : _b.id) || 'NONE', '(full object exists:', !!(currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.place_names_geojson_file), ')');
            console.log('[Country] Current Landuse file:', ((_c = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.landuse_geojson_file) === null || _c === void 0 ? void 0 : _c.id) || 'NONE', '(full object exists:', !!(currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.landuse_geojson_file), ')');
            console.log('[Country] Current Regions file:', ((_d = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.regions_geojson_file) === null || _d === void 0 ? void 0 : _d.id) || 'NONE', '(full object exists:', !!(currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.regions_geojson_file), ')');
            console.log('[Country] Current Highways file:', ((_e = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.highways_geojson_file) === null || _e === void 0 ? void 0 : _e.id) || 'NONE', '(full object exists:', !!(currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.highways_geojson_file), ')');
            ...
            const internalId = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.id;
            ...
            try {
                ...
                console.log('[Country] Could not check existing data counts:', (error === null || error === void 0 ? void 0 : error.message) || error);
            }
            ...
            const currentPoiFileId = (_f = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.pois_geojson_file) === null || _f === void 0 ? void 0 : _f.id;
            const currentLanduseFileId = (_g = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.landuse_geojson_file) === null || _g === void 0 ? void 0 : _g.id;
            const currentRegionsFileId = (_h = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.regions_geojson_file) === null || _h === void 0 ? void 0 : _h.id;
            const currentHighwaysFileId = (_j = currentCountry === null || currentCountry === void 0 ? void 0 : currentCountry.highways_geojson_file) === null || _j === void 0 ? void 0 : _j.id;
            ...
            console.error('[Country] Error stack:', error === null || error === void 0 ? void 0 : error.stack);
            throw error;
        }
    },
    /**
        ...
        try {
            ...
            try {
                const debugPayload = {
                    ...
                    filesRemoved,
                    countryWithFiles: {
                        id: countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.id,
                        documentId: countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.documentId,
                        highways_geojson_file_id: ((_a = countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.highways_geojson_file) === null || _a === void 0 ? void 0 : _a.id) || null,
                        highways_geojson_file_obj: (countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.highways_geojson_file) ? true : false
                    }
                };
                const debugPath = path_1.default.join(strapi.dirs.static.public, 'import_debug_highways.json');
                await promises_1.default.writeFile(debugPath, JSON.stringify(debugPayload, null, 2), 'utf-8');
                console.log('[Country] Wrote debug file to', debugPath);
            }
            catch (dbgErr) {
                console.warn('[Country] Failed to write debug file:', (dbgErr === null || dbgErr === void 0 ? void 0 : dbgErr.message) || dbgErr);
            }
            console.log('[Country] Re-fetched country with files:');
            console.log('  POI file:', ((_b = countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.pois_geojson_file) === null || _b === void 0 ? void 0 : _b.id) || 'NONE');
            console.log('  Landuse file:', ((_c = countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.landuse_geojson_file) === null || _c === void 0 ? void 0 : _c.id) || 'NONE');
            console.log('  Regions file:', ((_d = countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.regions_geojson_file) === null || _d === void 0 ? void 0 : _d.id) || 'NONE');
            console.log('  Highways file:', ((_e = countryWithFiles === null || countryWithFiles === void 0 ? void 0 : countryWithFiles.highways_geojson_file) === null || _e === void 0 ? void 0 : _e.id) || 'NONE');
            ...
            if (shouldDeletePOIs) {
                ...
                try {
                    ...
                    console.error('[Country] Error stack:', error === null || error === void 0 ? void 0 : error.stack);
                    importResults.push(`❌ POI deletion failed: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            ...
            if (shouldDeleteLanduse) {
                ...
                try {
                    ...
                    console.error('[Country] Error stack:', error === null || error === void 0 ? void 0 : error.stack);
                    importResults.push(`❌ Landuse deletion failed: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            ...
            if (shouldDeleteRegions) {
                ...
                try {
                    ...
                    console.error('[Country] Error stack:', error === null || error === void 0 ? void 0 : error.stack);
                    importResults.push(`❌ Region deletion failed: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            ...
            if (shouldDeleteHighways) {
                ...
                try {
                    ...
                    console.error('[Country] Error stack:', error === null || error === void 0 ? void 0 : error.stack);
                    importResults.push(`❌ Highway deletion failed: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            // Process POIs
            if (filesChanged.pois && countryData.pois_geojson_file) {
                ...
                try {
                    ...
                    importResults.push(`❌ POIs: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            else {
            ...
            if (filesChanged.landuse && countryData.landuse_geojson_file) {
                ...
                try {
                    ...
                    importResults.push(`❌ Landuse: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            else {
            ...
            if (filesChanged.regions && countryData.regions_geojson_file) {
                ...
                try {
                    ...
                    importResults.push(`❌ Regions: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            ...
            if (filesChanged.highways && countryData.highways_geojson_file) {
                ...
                try {
                    ...
                    importResults.push(`❌ Highways: ${(error === null || error === void 0 ? void 0 : error.message) || 'Unknown error'}`);
                }
            }
            else {
