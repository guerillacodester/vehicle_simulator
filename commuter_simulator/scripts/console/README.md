...
python -m commuter_simulator.scripts.console.list_passengers --route gg3pv3z19hhm117v9xth5ezq --start 2025-10-29T09:00:00Z --end 2025-10-29T10:00:00Z

# By depot
python -m commuter_simulator.scripts.console.list_passengers --depot abcd1234 --limit 50

# Recent only (table) and JSON modes
python -m commuter_simulator.scripts.console.list_passengers --limit 10 --sort createdAt:desc
python -m commuter_simulator.scripts.console.list_passengers --route gg3pv3z19hhm117v9xth5ezq --json | jq '.'
```
...
python -m commuter_simulator.scripts.console.stream_passenger_events

# Filter by route and output NDJSON
python -m commuter_simulator.scripts.console.stream_passenger_events --route gg3pv3z19hhm117v9xth5ezq --json | jq '.'
```

## Postgres Trigger (LISTEN/NOTIFY)
To emit events on inserts/updates to `active_passengers`, run:
- `commuter_simulator/scripts/sql/active_passengers_notify.sql`
