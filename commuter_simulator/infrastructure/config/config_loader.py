...
class AppConfig:
    ...
    commuter_simulator: CommuterSimulatorConfig
...
def find_config_file() -> Path:
    ...
    project_root = Path(__file__).resolve().parents[3]  # commuter_simulator/infrastructure/config -> root
...
def load_config() -> AppConfig:
    ...
    infrastructure = InfrastructureConfig(
        ...
        manifest_port=config.getint('infrastructure', 'manifest_port', fallback=4000),
    ...
    # Parse commuter_simulator section
    ...
    return AppConfig(
        ...
        commuter_simulator=commuter_sim,
