...
**Import example:**
```python
from commuter_simulator.domain.services.spawning import DepotSpawner, RouteSpawner
from commuter_simulator.domain.services.reservoirs import RouteReservoir
```
...
from commuter_simulator.infrastructure.config import SpawnConfigLoader
```
...
# CLI
python -m commuter_simulator.interfaces.cli.list_passengers --route 1 --json
```
