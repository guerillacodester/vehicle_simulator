...
class PassengerReservoir:
        ...
        try:
            ...
            for depot_id, depot_location in self.depot_locations.items():
                for route_id, route_geometry in self.route_geometries.items():
                    ...
                    passenger_count = max(0, int(np.random.poisson(expected_passengers)))
    ...
    def query_passengers(self, query: ReservoirQuery) -> List[SimplePassenger]:
        """
    ...
    def consume_passengers(self, passengers: List[SimplePassenger]) -> int:
        """
    ...
    async def _create_passenger_reservation(self, depot_id: str, route_id: str,
        ...
        try:
            ...
            # Create SimplePassenger passenger
            passenger = SimplePassenger(
