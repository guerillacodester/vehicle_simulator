...
Usage:
    ...
    python -m commuter_service.interfaces.cli.manifest_cli --day monday --route 1 --format barchart
    
    # Table for specific time range
    python -m commuter_service.interfaces.cli.manifest_cli --day monday --route 1 --format table --start-hour 7 --end-hour 9
    
    # Using specific date instead of day name
    python -m commuter_service.interfaces.cli.manifest_cli --date 2024-11-04 --route 1 --format table
"""
import asyncio
import argparse
