...
Usage examples:
    python -m commuter_service.interfaces.cli.list_passengers --route gg3pv3z19hhm117v9xth5ezq --start 2025-10-29T09:00:00Z --end 2025-10-29T10:00:00Z
    python -m commuter_service.interfaces.cli.list_passengers --depot abcd1234 --limit 50
    python -m commuter_service.interfaces.cli.list_passengers --limit 10 --sort createdAt:desc
    python -m commuter_service.interfaces.cli.list_passengers --route gg3pv3z19hhm117v9xth5ezq --json
"""
