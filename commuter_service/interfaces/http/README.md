...
**Location**: `commuter_service/interfaces/http/manifest_api.py` (Clean Architecture - Interfaces Layer)
...
- **Single source of truth**: Uses `application/queries/manifest_query` module (shared with CLI)
...
uvicorn commuter_service.interfaces.http.manifest_api:app --host 0.0.0.0 --port 4000 --reload
```
...
uvicorn commuter_service.interfaces.http.manifest_api:app --host 0.0.0.0 --port 4000 --workers 4
```
