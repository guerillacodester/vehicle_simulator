"""
Test the new StrapiApiClient and DepotCommuterSpawner integration
"""
...
async def test_depot_spawner():
    """Test the DepotCommuterSpawner with API client"""
    print("\n🏭 Testing DepotCommuterSpawner...")
    ...
    try:
        ...
        if await spawner.initialize():
            ...
            spawn_requests = await spawner.generate_commuter_spawn_requests(current_time, time_window_minutes=5)
            
            print(f"✅ Generated {len(spawn_requests)} commuter spawn requests")
