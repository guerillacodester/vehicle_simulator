...
# Passenger service moved to independent microservice - communicates via Strapi Socket.IO
...
class DepotManager(StateMachine, IDepotManager):
    def __init__(self, component_name: str = "DepotManager"):
        ...
        # Passenger service factory removed - now handled by independent microservice
        self.initialized = False
    
    def set_dispatcher(self, dispatcher: IDispatcher):
        self.dispatcher = dispatcher
        # Passenger service dispatcher connection removed - microservice handles its own connections
    ...
    async def shutdown(self) -> bool:
        # Passenger service shutdown handled by independent microservice
    ...
    async def distribute_routes_to_operational_vehicles(self, active_drivers: List = None) -> bool:
        ...
        try:
            ...
            # Passenger service startup handled by independent microservice
    ...
    # _start_passenger_service_after_routes method removed
    # Passenger service now runs as independent microservice
