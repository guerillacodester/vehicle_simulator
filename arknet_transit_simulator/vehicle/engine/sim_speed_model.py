...
def load_speed_model(name: str, **kwargs):
    """
    Load a speed model from arknet_transit_simulator.models.speed_models by name.
    ...
    if name == PHYSICS_MODEL_NAME:
        try:
            module = importlib.import_module("arknet_transit_simulator.vehicle.physics.physics_speed_model")
    ...
    module_name = f"arknet_transit_simulator.models.speed_models.{name}_speed"
