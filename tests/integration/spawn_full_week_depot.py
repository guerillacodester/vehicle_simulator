"""
Integration Test - Spawn Full Week of DEPOT Passengers for Route 1

Creates REAL depot passengers in the database for Route 1 over a full week (7 days x 24 hours).

Uses DepotSpawner to create passengers at the depot/terminal location.

After running this, you'll have ~4,000-5,000 real depot passenger records in the database
...
async def spawn_full_week_depot():
    """
    ...
    print("=" * 80)
    print("This will create REAL depot passengers in the database for 7 days x 24 hours")
    print("Estimated: 4,000-5,000 passenger records")
    print()
    ...
    # Create DepotReservoir (shared for all routes at depot)
    print("Initializing DepotReservoir...")
    depot_reservoir = DepotReservoir(
        passenger_repository=passenger_repo,
        enable_redis_cache=False
    )
    print("[OK] DepotReservoir initialized")
    print()
    
    # Initialize DepotSpawner
    print("Initializing DepotSpawner...")
    ...
    print(f"[OK] DepotSpawner initialized for Route {route_short_name}")
    print()
    ...
    print("=" * 80)
    print("SPAWNING DEPOT PASSENGERS - FULL WEEK")
    print("=" * 80)
    print()
    ...
    for day_offset in range(7):
        ...
        for hour in range(24):
            ...
            try:
                ...
                spawn_requests = await depot_spawner.spawn(
                ...
                if spawn_requests:
                    successful, failed = await depot_reservoir.push_batch(spawn_requests)
    ...
    if actual_created == total_spawned:
        print(f"[OK] SUCCESS: All {total_spawned} depot passengers created in database!")
    else:
