"""
Test Comprehensive Commuter Spawning System
============================================
...
from commuter_service.spawn_interface import (
    CommuterSpawnManager, 
    DepotSpawnStrategy, 
    RouteSpawnStrategy, 
    MixedSpawnStrategy,
    SpawnType
...
async def test_depot_spawning():
    ...
    async with StrapiApiClient() as client:
        ...
        requests = await manager.spawn_commuters(current_time, time_window_minutes=10)
...
async def test_route_spawning():
    """Test route-based commuter spawning"""
...
async def test_time_based_patterns():
    ...
    async with StrapiApiClient() as client:
        ...
        for hour, period_name in test_times:
            ...
            requests = await manager.spawn_commuters(test_time, time_window_minutes=10)
